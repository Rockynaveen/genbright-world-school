  ...
  return (
    <section className="relative z-10 overflow-hidden bg-white py-10 md:py-14">
      <div className="w-full overflow-hidden bg-white">
        <div className="grid items-stretch bg-white lg:grid-cols-[42%_58%]">
          <div className="relative z-20 flex flex-col justify-center bg-white px-6 py-8 sm:px-10 md:px-14 lg:px-20 lg:py-12 xl:px-24">
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="220"
              className="mt-5 max-w-[360px] text-[15px] font-medium leading-7 text-dark-navy/80 sm:text-[16px]"
              style={{ fontFamily: "Inter, sans-serif" }}
            >
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="700"
              className="mt-6 max-w-[390px] text-[14px] font-medium leading-7 text-dark-navy/80 sm:text-[15px]"
              style={{ fontFamily: "Inter, sans-serif" }}
            >
        ...
        <div className="relative z-30 px-4 pt-6 sm:px-6 md:px-10 lg:-mt-14">
          <div
            data-aos="fade-up"
            data-aos-delay="350"
            className="mx-auto grid w-full gap-5 rounded-[26px] border border-deep-teal/5 bg-white px-5 py-6 shadow-[0_20px_55px_rgba(8,43,53,0.1)] sm:grid-cols-2 sm:px-7 lg:grid-cols-4 lg:gap-0 lg:px-8"
          >
