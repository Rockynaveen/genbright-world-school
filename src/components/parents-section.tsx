...
export default function ParentQuestionsSection() {
  return (
    <section className="overflow-hidden bg-[#FFFDF8] py-6">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative mx-auto mt-3 h-[620px] max-w-[1000px]">
          <div
            className="absolute left-1/2 top-1/2 z-0 h-[560px] w-[560px] -translate-x-1/2 -translate-y-1/2 rounded-full border-2 border-dotted"
          ...
          <img
            ...
            alt="Parent"
            className="absolute left-1/2 top-[52%] z-20 h-[390px] -translate-x-1/2 -translate-y-1/2 object-contain"
          />

          <div className="absolute left-[220px] top-[82px] z-30">
            <QuestionCard
              icon={<Smile size={18} />}
          ...
          <div className="absolute right-[220px] top-[82px] z-30">
            <QuestionCard
              icon={<Star size={18} />}
              ...
              title={
                <>
                  ...
                  <br />
                  be{" "}
                  <span className="font-semibold" style={{ color: colors.freshGreen }}>
                    confident?
                  </span>
                </>
              }
          ...
          <div className="absolute left-[115px] top-[245px] z-30">
            <QuestionCard
              icon={<Heart size={18} />}
          ...
          <div className="absolute right-[115px] top-[245px] z-30">
            <QuestionCard
          ...
          <div className="absolute bottom-[52px] left-1/2 z-30 -translate-x-1/2">
            <QuestionCard
              icon={<Globe2 size={18} />}
