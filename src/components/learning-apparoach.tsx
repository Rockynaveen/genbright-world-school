    ...
    <section className="w-full bg-[#FFFDF8] py-14 md:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[34%_66%] lg:gap-0">
          ...
          <div
            data-aos="fade-up"
            className="flex flex-col items-start justify-center border-b border-deep-teal/15 pb-10 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-12"
          >
            <h2 className="max-w-[340px] text-[36px] leading-[1.05] text-dark-navy sm:text-[44px] lg:text-[48px] font-heading">
              We don’t start
              <br />
              with subjects.
              <br />
            ...
            <button className="mt-7 inline-flex items-center gap-2 rounded-full bg-deep-teal px-6 py-3 text-[13px] font-semibold text-white transition-all duration-300 hover:bg-dark-navy font-sans">
            ...
            {items.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-[20px] leading-tight text-deep-teal font-heading">
                    {item.title}
                  </h3>

                  <p className="mx-auto mt-4 max-w-[210px] text-[14px] leading-[1.7] text-dark-navy/75 font-sans">
                    {item.text}
                  </p>
                </div>
              );
